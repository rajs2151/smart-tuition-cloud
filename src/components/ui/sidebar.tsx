  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:hidden",
        // Always visible on touch-sized viewports; hide until hover/focus on md+.
        showOnHover &&
          "opacity-100 group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 peer-data-[active=true]/menu-button:text-sidebar-accent-foreground md:opacity-0 md:group-hover/menu-item:opacity-100",
        className,
      )}
      {...props}
    />
